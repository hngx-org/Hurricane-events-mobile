                      ...
                      children: [
                        TabBar(
                          ...
                          indicatorSize: TabBarIndicatorSize.label,
                            ...
                            tabs: [
                              CustomTab(currentIndex: currentIndex, title: 'Friends', index: 0,),
                              CustomTab(currentIndex: currentIndex, title: 'Everyone', index: 1,),
                            ],
                        ),
                        20.height,
                        SingleChildScrollView(
                          child: Column(
                              children: sampleData.map((data) => TimelineCard(
                                  title: data.title,
                                  onTap: (){},
                                  moreButtonFunction: (){},
