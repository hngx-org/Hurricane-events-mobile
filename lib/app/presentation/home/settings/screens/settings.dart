  ...
  Widget build(BuildContext context) {
    return Consumer<UserProvider>(builder: (context, userProvider, _) {
      return FutureBuilder<AppUser?>(
        future:
            userProvider.getUserDetails("b3ddafb6-a59a-48a2-aa4d-2fbfc986c4bd"),
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      ListTile(
                        leading:
                            ClipOval(child: Image.asset(AppImages.imgSamuel)),
                        ...
                        subtitle: Text(
                          ...
                          style: context.body2.copyWith(
                              fontSize: 12, color: AppColors.designBlack5),
                        ),
                        trailing: const Icon(
